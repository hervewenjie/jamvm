...
//#ifndef UNTITLED2_JAM_H
//#define UNTITLED2_JAM_H
//
//#endif //UNTITLED2_JAM_H
...
typedef struct constant_pool {
    ...
    ConstantPoolEntry *info;  // entry list
} ConstantPool;
...
typedef struct classblock {
    ...
    int object_size;            // instance field size
    FieldBlock *fields;
    MethodBlock *methods;
    Class **interfaces;
